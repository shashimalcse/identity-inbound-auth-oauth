...
public class DefaultOIDCClaimsCallbackHandler implements CustomClaimsCallbackHandler {
    ...
    private Map<String, Object> getUserClaimsInOIDCDialect(String spTenantDomain, String clientId,
        ...
        List<String> requestedClaimUris;
        ...
        requestedClaimUris = getRequestedClaimUris(requestClaimMappings);
    ...
    private static ClaimMapping[] getRequestedClaimMappings(ServiceProvider serviceProvider) {
    ...
    private static List<String> getRequestedClaimUris(ClaimMapping[] requestedLocalClaimMap) {
    ...
    private Map<String, Object> filterOIDCClaims(OAuthTokenReqMessageContext requestMsgCtx,
        ...
        String token = OIDCClaimUtil.getAccessToken(requestMsgCtx);
        String authorizationCode = OIDCClaimUtil.getAuthorizationCode(requestMsgCtx);
    ...
    private Map<String, Object> filterOIDCClaims(OAuthAuthzReqMessageContext authzReqMessageContext,
        ...
        String accessToken = OIDCClaimUtil.getAccessToken(authzReqMessageContext);
